...
ItemTileCheckList:
	%ItemTile(!RightS, !Cra, 1, $02, $01) : %ItemTile(!RightS, !Cra, 1, $06, $06) : %ItemTile(!RightS, !Cra, 1, $01, $07) : %ItemTile(!RightS, !Cra, 1, $03, $06)	;item $000 - $003
	%ItemTile(!RightS, !Cra, 1, $05, $04) : %ItemTile(!RightS, !Cra, 0, $03, $11) : %ItemTile(!RightS, !Cra, 0, $13, $14) : %ItemTile(!RightS, !Cra, 0, $07, $19)	;item $004 - $007
	...
	%ItemTile(0, 0, 0, $00, $00) : %ItemTile(!RightS, !Brn, 0, $08, $11) : %ItemTile(!RightS, !Brn, 0, $0B, $11) : %ItemTile(!RightS, !Brn, 0, $0C, $11)	;item $014 - $017
	%ItemTile(!RightS, !Brn, 0, $09, $0F) : %ItemTile(!RightS, !Brn, 0, $0C, $16) : %ItemTile(!RightS, !Brn, 0, $0B, $19) : %ItemTile(!RightS, !Brn, 0, $0B, $17)	;item $018 - $01B
	%ItemTile(!RightS, !Brn, 1, $0B, $00) : %ItemTile(!RightS, !Brn, 0, $0B, $1F) : %ItemTile(!RightS, !Brn, 0, $0B, $06) : %ItemTile(!RightS, !Brn, 0, $0B, $05)	;item $01C - $01F
	%ItemTile(0, 0, 0, $00, $00) : %ItemTile(!RightS, !Brn, 0, $0E, $08) : %ItemTile(!RightS, !Brn, 0, $0C, $1C) : %ItemTile(!RightS, !Brn, 0, $09, $15)	;item $020 - $023
	%ItemTile(!RightS, !Brn, 0, $09, $1D) : %ItemTile(!RightS, !Brn, 0, $09, $1D) : %ItemTile(!RightS, !Brn, 0, $10, $17) : %ItemTile(!RightS, !Brn, 1, $09, $03)	;item $024 - $027
	%ItemTile(!RightS, !Brn, 1, $0C, $03) : %ItemTile(!RightS, !Brn, 1, $0C, $02) : %ItemTile(!RightS, !Brn, 1, $12, $06) : %ItemTile(!RightS, !Brn, 1, $14, $0B)	;item $028 - $02B
	%ItemTile(!RightS, !Brn, 1, $13, $0F) : %ItemTile(0, 0, 0, $00, $00) : %ItemTile(0, 0, 0, $00, $00) : %ItemTile(0, 0, 0, $00, $00)	;item $02C - $02F
	%ItemTile(!RightS, !Brn, 1, $14, $19) : %ItemTile(!RightS, !Nor, 0, $05, $10) : %ItemTile(!RightS, !Nor, 0, $03, $05) : %ItemTile(!RightS, !Nor, 0, $05, $02)	;item $030 - $033
	%ItemTile(!RightS, !Nor, 0, $0B, $13) : %ItemTile(!RightS, !Nor, 0, $07, $07) : %ItemTile(!RightS, !Nor, 0, $07, $0B) : %ItemTile(!RightS, !Nor, 0, $06, $08)	;item $034 - $037
	...
	%ItemTile(!RightS, !Nor, 0, $11, $03) : %ItemTile(!RightS, !Nor, 0, $03, $12) : %ItemTile(!RightS, !Nor, 0, $03, $12) : %ItemTile(!RightS, !Nor, 0, $03, $15)	;item $03C - $03F

	%ItemTile(!RightS, !Nor, 0, $06, $17) : %ItemTile(!RightS, !Nor, 1, $03, $04) : %ItemTile(!RightS, !Nor, 1, $03, $05) : %ItemTile(!RightS, !Nor, 0, $05, $1A)	;item $040 - $043
	%ItemTile(!RightS, !Nor, 0, $05, $1D) : %ItemTile(0, 0, 0, $00, $00) : %ItemTile(!RightS, !Nor, 0, $10, $12) : %ItemTile(!RightS, !Nor, 0, $10, $13)	;item $044 - $047
	%ItemTile(0, 0, 0, $00, $00) : %ItemTile(!RightS, !Nor, 0, $0B, $1C) : %ItemTile(!RightS, !Nor, 1, $06, $03) : %ItemTile(!RightS, !Nor, 1, $07, $05)	;item $048 - $04B
	%ItemTile(!RightS, !Nor, 1, $0F, $00) : %ItemTile(!RightS, !Nor, 0, $06, $1D) : %ItemTile(!RightS, !Nor, 0, $12, $16) : %ItemTile(!RightS, !Nor, 0, $11, $14)	;item $04C - $04F
	...
	%ItemTile(!RightS, !WkS, 0, $0E, $12) : %ItemTile(!RightS, !WkS, 0, $12, $0F) : %ItemTile(!RightS, !WkS, 0, $12, $15) : %ItemTile(!RightS, !WkS, 0, $0E, $0A)	;item $084 - $087
	%ItemTile(!RightS, !Mar, 0, $0D, $0A) : %ItemTile(!RightS, !Mar, 0, $0C, $0B) : %ItemTile(!RightS, !Mar, 0, $0D, $12) : %ItemTile(!RightS, !Mar, 0, $0E, $13)	;item $088 - $08B
	%ItemTile(!RightS, !Mar, 0, $07, $0C) : %ItemTile(!RightS, !Mar, 0, $07, $0C) : %ItemTile(!RightS, !Mar, 0, $07, $14) : %ItemTile(!RightS, !Mar, 0, $03, $1C)	;item $08C - $08F
	...
	%ItemTile(!RightS, !Mar, 0, $0A, $18) : %ItemTile(!RightS, !Mar, 0, $0A, $19) : %ItemTile(!RightS, !Mar, 1, $11, $01) : %ItemTile(!RightS, !Mar, 1, $08, $0A)	;item $094 - $097
	%ItemTile(!RightS, !Mar, 0, $09, $1D) : %ItemTile(0, 0, 0, $00, $00) : %ItemTile(!RightS, !Mar, 1, $0B, $06) : %ItemTile(0, 0, 0, $00, $00)	;item $098 - $09B
