...
;---------------------------------------------------------------------------------------------------
{
;Alternative offset math for right half tilemap of vertical scrolling DMA
ORG $808DDB : REP #$21 : TYA : ADC #$0020
ORG $808E0D : REP #$21 : TYA : ADC #$0020
ORG $808E50 : REP #$21 : TYA : ADC #$0020
ORG $808E88 : REP #$21 : TYA : ADC #$0020
...
ORG $80A211 : LDX #$07FE		;reduce the clearing size from $F00 to $800
ORG $80A217 : STA $7E5800,x		;change position for clearing FX tilemap to $7E5800
ORG $80A222 : LDA #$0800
ORG $80A227 : LDA #$5800
ORG $80A231 : LDA #$5C00		;change VRAM location to the space where FX effects get truely occupied


;ORG !FreespaceBank80_VRAM
ORG !free80
print "Map freespace 80 starts: ", pc
NMI_MinimapHijack:
...
;---------------------------------------BANK $84----------------------------------------------------
ORG $848CA6
	JSL ConstructMapFromMapStation		;set map and adjust pause menu indexs
	PLY : PLX : RTS						;revert previous changes
