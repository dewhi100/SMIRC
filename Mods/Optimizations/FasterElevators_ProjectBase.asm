;So I don't know- This says DSO (Deep Space Observer), but it's hosted in Project Base. Guess they just used his stuff? No idea how modified it is from the original, if at all.
