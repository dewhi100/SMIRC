;Kejardon's base TransitionTable.asm file with tweaks for SparkBounce.
;If you have your own TransitionTable file, you can remove the T20 and T21 lines in it, and copy the bottom of this file to your TransitionTable file instead.
...
;Start of SparkBounce code. If you have your own TransitionTable patch, copy the below into it.
